  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tr>
        ...
        <td>
          <a href="/student/view-history?pe={{ $record->id }}" class="btn btn-sm btn-primary">View</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Are you sure you want to analyze <span id="facultyName"></span> (ID: <span id="facultyId"></span>) for academic year <span id="academicYear"></span>, <span id="semester"></span> semester?<span id="eval_id"></span>
      </div>
